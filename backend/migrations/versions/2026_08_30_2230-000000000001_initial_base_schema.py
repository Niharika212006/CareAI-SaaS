...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('role', postgresql.ENUM('PATIENT', 'DOCTOR', 'ADMIN', 'LAB_TECHNICIAN', 'PHARMACY_STAFF', name='userrole', create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('approval_status', postgresql.ENUM('PENDING', 'APPROVED', 'REJECTED', name='doctorapprovalstatus', create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('PENDING', 'CONFIRMED', 'CANCELLED', 'COMPLETED', 'REJECTED', name='appointmentstatus', create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('overall_risk_level', postgresql.ENUM('NONE', 'LOW', 'MODERATE', 'HIGH', 'CRITICAL', name='interactionseverity', create_type=False), nullable=False),
